...
<html lang="es">
  <head>
    ...
    <title>Panel de administracion - UGEL</title>
  ...
  <body>
            ...
            <img class="logo-ugel" src="../tema/img/LogoUgelChincha.png">
  			...
  			<div class="navbar-collapse collapse">
  				...
  				<ul class="nav navbar-nav navbar-right menu-op-adm">
  					<li><a href="agregar_resolucion.php"><i class="glyphicon glyphicon-file"></i>Agregar resolución</a></li>
            <li><a href="agregar_personas.php"><i class="glyphicon glyphicon-user"></i>Agregar persona</a></li>
            <li><a href="agregar_institucion.php"><i class="glyphicon glyphicon-education"></i>Agregar institución</a></li>
            <li><a href="lista_resolucion.php"><i class="glyphicon glyphicon-search"></i>Buscar resolución</a></li>
  	...
  	<div class="contenedor-app">
  		<aside class="menu-izquierdo">
              ...
              <li> 
                <a href="mantenimiento_resolucion.php">
                  <i class="glyphicon glyphicon-file"></i> 
                  <span class="nav-label">Mantenimiento Resolución</span> 
                </a>
              </li>

			        <li> 
			        	<a href="mantenimiento_persona.php">
			        		<i class="glyphicon glyphicon-user"></i> 
			        		<span class="nav-label">Mantenimiento Persona</span> 
			        	</a>
			        </li>

			        <li> 
			        	<a href="mantenimiento_usuario.php">
			        		<i class="glyphicon glyphicon-lock"></i> 
			        		<span class="nav-label">Mantenimiento Usuario</span> 
			        	</a>
			        </li>

              <li> 
                <a href="mantenimiento_ambiente.php">
                  <i class="glyphicon glyphicon-list-alt"></i> 
                  <span class="nav-label">Mantenimiento Ambiente</span> 
                </a>
              </li>

			        <li> 
			        	<a href="mantenimiento_institucion.php">
			        		<i class="glyphicon glyphicon-education"></i> 
			        		<span class="nav-label">Mantenimiento Institución</span> 
			        	</a>
			        </li>
              ...
              <li> 
                <a href="operaciones_resolucion.php">
                  ...
                  <span class="nav-label">Operaciones Resolución</span> 
                </a>
              </li>
