...
<div class="row">
	...
	<h2 class="text-center title-container"><i class="glyphicon glyphicon-floppy-saved"></i> OPCIONES DE MANTENIMIENTO DE INSTITUCIÓN</h2>

	<br>

	<!-- SE CREAN TODAS LAS OPCIONES QUE TENDRA EL MODULO INSTITUCION -->

    <!-- OPCION AGREGAR INSTITUCION -->
	<div class="col-md-4 box-card">
		<div class="card-adm2">
			<div class="col-md-12 red-title" id="titulo-card-admi">
				<center><span>Agregar Institución</span></center>
			</div>
			<div class="col-md-12 red-body" id="body-card-admi">
				...
				<div class="col-md-8" id="content-card-admi">
					Esta sección le permite registrar una institución al sistema
				</div>
			</div>
			<div class="col-md-12 red-footer" id="footer-card-admi">
				<div class="col-md-9">
					<a href="agregar_institucion.php">Realizar mantenimiento</a>
				</div>
	...
	<!-- OPCION BUSCAR INSTITUCION -->
	<div class="col-md-4  box-card">
		<div class="card-adm2">
			<div class="col-md-12 blue-title" id="titulo-card-admi">
				<center><span>Buscar Institución</span></center>
			</div>
			...
			<div class="col-md-12 blue-footer" id="footer-card-admi">
				<div class="col-md-9">
					<a href="lista_institucion.php">Realizar mantenimiento</a>
				</div>
				<div class="col-md-3 text-right">
					<i class="glyphicon glyphicon-chevron-right"></i>
				</div>
