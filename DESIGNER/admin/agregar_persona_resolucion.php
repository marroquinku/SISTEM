...
require_once '../../BOL/Detalle_resolucion_persona.php';
require_once '../../DAO/Detalle_resolucion_personaDAO.php';
...
$detalle_resolucion_personaDAO = new Detalle_resolucion_personaDAO();

//SE CREA UNA CONDICIONAL PARA VALIDAR SI EL BOTON CON NAME "btn-guardar-pr-a" ESTA RECIBIENDO VALORES, DE SER ASI, SE GUARDAN EN EL SISTEMA
if(isset($_POST['btn-guardar-pr-a']))
{
	if (isset($_POST['id_resolucion_pr']) && !empty($_POST['id_resolucion_pr'])) {
		...
		foreach($idPersonas as $key => $n ) {
        $detalle_resolucion_persona = new Detalle_resolucion_persona();
        $detalle_resolucion_persona->__GET('id_persona')->__SET('id_persona',$n);
        $detalle_resolucion_persona->__GET('id_resolucion')->__SET('id_resolucion',$idResolucion);
        $detalle_resolucion_personaDAO->Registrar($detalle_resolucion_persona);
     }
     echo $mensajeFinalS;
   ...
   <div class="col-md-12">
      <div class="form-group">
        <h5 class="text-center title-container">
          <i class="glyphicon glyphicon-list-alt"></i> AGREGAR PERSONA A RESOLUCIÓN
       </h5>
    </div>
...
<div class="div_pestania_base">
   ...
   <div class="box-view minimizado"  style="display: none;">
      <br>
      <table class="table table-striped" id="personas-rd">
       <thead>
         <tr class="success">
 ...
 <div class="table-responsive principal-tb">
   <table class="table">
      <tr>
        <td>
           <input type="hidden" id="idPersonaNs" value="123456">
           <div class="input-group">
              <span class="input-group-addon" for="ProcessNum">Documento</span>    
              <input type="number" id="documentoKeyEnter" class="floatLabel form-control">
           </div>
      </td>
   </tr>
   <tr>
      <td  align="center">
         <div class="input-group">
              ...
              <input type="text" id="pr_nombre" class="floatLabel form-control" readonly>
         </div>
      </td>
      <td  align="center">
         <div class="input-group">
              <span class="input-group-addon" for="ProcessNum">Apellido Paterno</span>    
            <input type="text" id="pr_apellidoP" class="floatLabel form-control" readonly>
         </div>
      </td>
   </tr>
   <tr>
      <td  align="center">
         <div class="input-group">
            ...
            <input type="text" id="pr_apellidoM" class="floatLabel form-control" readonly>
         </div>
      </td>
      <td  align="center">
          <div class="input-group">
              <span class="input-group-addon" for="ProcessNum">Edad</span>    
            <input type="text" id="pr_FechaNacimiento" class="floatLabel form-control" readonly>
         </div>
      </td>
   </tr>
   <tr>
     <td align="left">
       <button class="btn btn-success" id="btn_pr_persona" disabled>Agregar Persona</button>
    </td>
 </tr>
</table>
</div>
...
<div class="text-right" style="margin-top: 20px;">
  <button name="btn-guardar-pr-a" class="btn btn-primary">Registrar personas a resolución</button>
</div>
</form>
</div>
</div>
