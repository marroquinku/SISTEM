	...
	<div class="col-md-4 box-card">
		<div class="card-adm2">
			<div class="col-md-12 red-title" id="titulo-card-admi">
				<center><span>Recibir Resolucion</span></center>
			</div>
			<div class="col-md-12 red-body" id="body-card-admi">
				...
				<div class="col-md-8" id="content-card-admi">
					Esta seccion le permite recibir las resoluciones enviada por la oficina de mesa de parte
				</div>
			</div>
			<div class="col-md-12 red-footer" id="footer-card-admi">
				<div class="col-md-9">
					<a href="recepcion_resolucion.php">Realizar mantenimiento</a>
				</div>
	...
	<div class="col-md-4  box-card">
		<div class="card-adm2">
			...
			<div class="col-md-12 blue-body" id="body-card-admi">
				...
				<div class="col-md-8" id="content-card-admi">
					Esta seccion le permite buscar las resoluciones que usted a recibido por parte de la oficina mesa de parte
				</div>
			</div>
			<div class="col-md-12 blue-footer" id="footer-card-admi">
				<div class="col-md-9">
					<a href="buzon_resolucion.php">Realizar mantenimiento</a>
				</div>
				<div class="col-md-3 text-right">
					<i class="glyphicon glyphicon-chevron-right"></i>
				</div>
